<div id="skin-select">
    <div id="logo">
        <h1 style="text-align:left;">
            <a href="/gpms/dashboard.php" style="color:#ffffff;"><img src="/gpms/images/synokem-logo.png" style="margin-right: 5px; margin-top: -8px;" width="30" alt="logo"> gpms </a>
        </h1>
    </div>
    <a id="toggle">
        ...
        <div id="tree-wrap">
            <div class="side-bar">
                <ul class="topnav menu-left-nest">
                    ...
                    <li>
                        <a class="tooltip-tip ajax-load" href="/gpms/dashboard.php" title="Create Pass">
                            <i class="icon-home"></i>
                            <span>Home</span>
                        </a>
                    </li>
